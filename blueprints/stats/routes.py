...
def stats():
    ...
    if(current_user.Profile=='Artist'):
        ...
        users_like_songs=session.query(Users).filter(Users.Email.in_(session.query(Users_liked_Songs.user_email).filter(Users_liked_Songs.song_id.in_(my_liked_songs))))
        ...
        users_like_albums=session.query(Users).filter(Users.Email.in_(session.query(Users_liked_Albums.user_email).filter(Users_liked_Albums.album_id.in_(my_liked_albums))))
